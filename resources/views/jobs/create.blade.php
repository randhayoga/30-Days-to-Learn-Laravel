    ...
    <div class="space-y-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="mt-2">
                ...
                <input id="title" type="text" name="title" placeholder="DevOps Engineer" class="block min-w-0 grow bg-transparent py-1.5 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6" required />
                </div>
                @error('title')
            ...
            <div class="mt-2">
                ...
                <input id="salary" type="text" name="salary" placeholder="50,000" class="block min-w-0 grow bg-transparent py-1.5 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6" required />
                </div>
                @error('salary')
